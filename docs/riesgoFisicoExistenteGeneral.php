               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Riesgo Fisico Existente</span></h4>
                </li>
				</center>    
...
if($rr=="Rios" && $acumulador>=45){

$c1++;
}

if($rr=="Deslizamientos de Montañas" && $acumulador>=45){

    $c2++;
    }

    if($rr=="Deslizamientos de Volcán" && $acumulador>=45){

        $c3++;
        }

        if($rr=="Taludes" && $acumulador>=45){

            $c4++;
            }


            if($rr=="Carcava" && $acumulador>=45){
...
total="<?php echo $total=$c1+$c2+$c3+$c4+$c5+$c6+$c7; ?>";
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Rios','Deslizamientos de Montañas','Deslizamientos de Volcán','Taludes','Carcava','Otros','Ninguno']},
...
Rios: <?php echo $c1; ?><br>
Deslizamientos de Montañas: <?php echo $c2; ?><br>
Deslizamientos de Volcán: <?php echo $c3; ?><br>
Taludes: <?php echo $c4; ?><br>
Carcava: <?php echo $c5; ?><br>
Otros: <?php echo $c6; ?><br>
