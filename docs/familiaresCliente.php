...
<div class="form-group">
  ...
  <div class="col-md-5">
    ...
    <button type="reset" id="cancelar" name="cancelar" class="btn btn-danger"><i class="zmdi zmdi-undo"></i> Cancelar</button>
	 ...
	 <button type="button" id="btno" name="btno" class="btn btn-warning" onClick="sinRecetar()"><i class="zmdi zmdi-close"></i> No Guardar</button>
