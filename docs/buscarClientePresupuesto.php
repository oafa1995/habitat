...
<script type="text/javascript" class="init">
	...
	window.open("solicitudesPresupuesto.php?iddatos="+id, '_parent');
	}
...
if($acumulador>=45){
            ...
            <tr>
                ...
                <td class="text-center"><a class='btn btn-success btn-xs' onClick="llamarPaginaEditar2('<?php echo $filaw[0]; ?>')"><span class="glyphicon glyphicon-edit"></span> Ingresar Presupuesto</a></td>
