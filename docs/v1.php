...
<body>
  ...
  <div class="container-fluid"  style="margin: 50px 0;">
        ...
        <div class="container-fluid">
            ...
            <li role="presentation"><a href="clientesAprobados.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Clientes Aprobados</a></li>
				<li role="presentation"><a href="clientesNoAprobados.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Clientes Rechazados</a></li>
				<li role="presentation"><a href="mujeresAprobadas.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Mujeres con subsidio aprobado</a></li>
                <li role="presentation"><a href="hombresAprobados.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Hombres con subsidio aprobado</a></li>
                <li role="presentation"><a href="hombresvsmujereAp.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Hombres VS Mujeres</a></li>
            </ul>
