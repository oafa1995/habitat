			...
			<!--aqui va la foto del usuario -->
               ...
               <center>
				<br>
                 ...
                 <h4><span class="all-tittles">Afectación de ingresos</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Enfermedad"){ $c1++;
     	}
         
         if($acumulador>=45 && $rr=="Despedido de empleo"){ $c2++;                    
          }  
          
          if($acumulador>=45 && $rr=="Renuncia al trabajo"){ $c3++;                    
          }   
          
          if($acumulador>=45 && $rr=="Disminución de las ventas"){ $c4++;                    
          }   
          
          if($acumulador>=45 && $rr=="Inseguridad Social"){ $c5++;                    
          }       
          
          if($acumulador>=45 && $rr=="COVID"){ $c6++;                    
          }   
          
          if($acumulador>=45 && $rr=="Desastre natural"){ $c7++;                    
          } 
           if($acumulador>=45 && $rr=="Otros"){ $c8++;                    
          }   
          
          if($acumulador>=45 && $rr=="Ninguno"){ $c9++;                    
          } 
...
total="<?php echo $c1+$c2+$c3+$c4+$c5+$c6+$c7+$c8+$c9; ?>";
...
/*
 if($acumulador>=45 && $rr=="Enfermedad"){ $c1++;
     	}
         ...
         if($acumulador>=45 && $rr=="Despedido de empleo"){ $c2++;                    
          ...
          if($acumulador>=45 && $rr=="Disminución de las ventas"){ $c3++;                    
          }   
          
          if($acumulador>=45 && $rr=="Inseguridad Social"){ $c3++;                    
          }       
          
          if($acumulador>=45 && $rr=="COVID"){ $c3++;                    
          }   
          
          if($acumulador>=45 && $rr=="Desastre natural"){ $c3++;                    
          } 
           if($acumulador>=45 && $rr=="Otros"){ $c3++;                    
          }   
          
          if($acumulador>=45 && $rr=="Ninguno"){ $c3++;                    
          } 
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		backgroundColor: ['blue','red','green','brown','cyan','purpure','black','orange','pink'],
		label: 'Comparacion de navegadores'}],
		labels: ['Enfermedad','Despedido de empleo','Renuncia al trabajo','Disminución de las ventas','Inseguridad Social','COVID','Desastre natural','Otros','Ninguno']},
    options: options
});
...
Enfermedad: <?php echo $c1; ?><br>
Despedido de empleo: <?php echo $c2; ?><br>
Renuncia al trabajo: <?php echo $c3; ?><br>
Disminución de las ventas: <?php echo $c4; ?><br>
Inseguridad Social: <?php echo $c5; ?><br>
COVID: <?php echo $c6; ?><br>
Desastre natural: <?php echo $c7; ?><br>
Otros: <?php echo $c8; ?><br>
Ninguno: <?php echo $c9; ?><br>
