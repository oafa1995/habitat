               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Cliente Aprobados que reciben Remesa</span></h4>
                </li>
				</center>    
...
Recibe: <?php echo $conM; ?><br>
No recibe: <?php echo $conH; ?><br>
       Total: <?php echo $conH+$conM; ?>
