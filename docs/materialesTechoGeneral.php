               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Materiales de techo de vivienda evaluada</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Teja"){ $c1++;
     	}
         
          if($acumulador>=45 && $rr=="Lámina"){ $c2++;                    
          }   

          if($acumulador>=45 && $rr=="Duralita"){ $c3++;                    
          } 

           
             if($acumulador>=45 && $rr=="Plástico"){ $c4++;                    
          }   

             if($acumulador>=45 && $rr=="Palma"){ $c5++;                    
          }   
          
       if($acumulador>=45 && $rr=="Otro"){ $c6++;                    
          }   
...
/*
  ...
  if($acumulador>=45 && $rr=="Bloque"){ $c1++;
     	}
         
         if($acumulador>=45 && $rr=="Ladrillo"){ $c2++;                    
          }  
          
          if($acumulador>=45 && $rr=="Adobe"){ $c3++;                    
          }   
          
          if($acumulador>=45 && $rr=="Lámina"){ $c4++;                    
          }   
            if($acumulador>=45 && $rr=="Plástico"){ $c5++;                    
          }   
             if($acumulador>=45 && $rr=="Bahareque"){ $c6++;                    
          }   
          
       if($acumulador>=45 && $rr=="Otro"){ $c7++;                    
          }   
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		backgroundColor: ['blue','red','green','brown','purple','black'],
		label: 'Comparacion de navegadores'}],
		labels: ['Teja','Lámina','Duralita','Plástico','Palma','Otro']},
    options: options
});
...
Teja: <?php echo $c1; ?><br>
Lámina: <?php echo $c2; ?><br>
Duralita: <?php echo $c3; ?><br>
Plástico: <?php echo $c4; ?><br>
Palma: <?php echo $c5; ?><br>
Otro: <?php echo $c6; ?><br>
