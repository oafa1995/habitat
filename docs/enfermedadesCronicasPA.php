               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">¿Qué Enfermedades crónicas se padece en la familia?</span></h4>
                </li>
				</center>    
...
if($palabras[$i]=="Diabétes" && $acumulador>=45){

$c1++;
}

if($palabras[$i]=="Presión Arterial" && $acumulador>=45){

    $c2++;
    }

    if($palabras[$i]=="Enfermedades Respiratorias" && $acumulador>=45){

        $c3++;
        }
         if($palabras[$i]=="Cancer" && $acumulador>=45){

        $c4++;
        }
 if($palabras[$i]=="Insuficiencia Renal" && $acumulador>=45){
        ...
        if($palabras[$i]=="COVID-19" && $acumulador>=45){
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Diabétes','Presión Arterial','Enfermedades Respiratorias','Cancer','Insuficiencia Renal','COVID-19','Otros','Ninguna']},
...
Diabétes: <?php echo $c1." de ".$contando; ?><br>
Presión Arterial: <?php echo $c2." de ".$contando; ?><br>
Enfermedades Respiratorias: <?php echo $c3." de ".$contando; ?><br>
Cancer: <?php echo $c4." de ".$contando; ?><br>
Insuficiencia Renal: <?php echo $c5." de ".$contando; ?><br>
COVID-19: <?php echo $c6." de ".$contando; ?><br>
Otros: <?php echo $c7." de ".$contando; ?><br>
Ninguna: <?php echo $c8." de ".$contando; ?><br>
