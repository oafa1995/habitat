               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">¿Cuál fue el nivel de afectación?</span></h4>
                </li>
				</center>    
...
if($rr=="Pérdida completa de vivienda" && $acumulador>=45){

$c1++;
}

if($rr=="Daño parcial de vivienda" && $acumulador>=45){
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Pérdida completa de vivienda','Daño parcial de vivienda','Ninguno']},
...
Pérdida completa de vivienda: <?php echo $c1; ?><br>
Daño parcial de vivienda: <?php echo $c2; ?><br>
Ninguno: <?php echo $c3; ?><br>
