               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Número de espacios en viviendas</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="1"){ $c1++;
     	}
         
         if($acumulador>=45 && $rr=="2"){ $c2++;                    
          }  
          
          if($acumulador>=45 && $rr=="3"){ $c3++;                    
          }   
          
          if($acumulador>=45 && $rr=="Mas de 3"){ $c4++;                    
          }   
