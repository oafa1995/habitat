               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Tenencia de la propiedad</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Propia"){ $c1++;
     	}
         
         if($acumulador>=45 && $rr=="Financiada"){ $c2++;                    
          }  
          
          if($acumulador>=45 && $rr=="Alquilada"){ $c3++;                    
          }   
          
          if($acumulador>=45 && $rr=="Familiar"){ $c4++;                    
          }   
            if($acumulador>=45 && $rr=="Prestada"){ $c5++;                    
          }   
           if($acumulador>=45 && $rr=="Colono"){ $c6++;                    
          }   
           if($acumulador>=45 && $rr=="Otra"){ $c7++;                    
          } 
          
          if($acumulador>=45 && $rr=="Ninguna"){ $c8++;                    
          }   
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		backgroundColor: ['blue','red','green','brown','cyan','purpure','black','orange'],
		label: 'Comparacion de navegadores'}],
		labels: ['Propia','Financiada','Alquilada','Familiar','Prestada','Colono','Otra','Ninguna']},
    options: options
});
...
Propia: <?php echo $c1; ?><br>
Financiada: <?php echo $c2; ?><br>
Alquilada: <?php echo $c3; ?><br>
Familiar: <?php echo $c4; ?><br>
Prestada: <?php echo $c5; ?><br>
Colono: <?php echo $c6; ?><br>
Otra: <?php echo $c7; ?><br>
Ninguna: <?php echo $c8; ?><br>
