...
<body>
  ...
  <div class="container-fluid"  style="margin: 50px 0;">
        ...
        <div class="container-fluid">
            ...
            <li role="presentation"><a href="clientesAprobadosPA.php?iddatos=<?php echo $iddatos; ?>"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Clientes Aprobados</a></li>
				<li role="presentation"><a href="clientesNoAprobadosPA.php?iddatos=<?php echo $iddatos; ?>"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Clientes Rechazados</a></li>
				<li role="presentation"><a href="mujeresAprobadasPA.php?iddatos=<?php echo $iddatos; ?>"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Mujeres con subsidio aprobado</a></li>
                <li role="presentation"><a href="hombresAprobadosPA.php?iddatos=<?php echo $iddatos; ?>"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Hombres con subsidio aprobado</a></li>
                <li role="presentation"><a href="hombresvsmujereApPA.php?iddatos=<?php echo $iddatos; ?>"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Hombres VS Mujeres</a></li>
            </ul>
