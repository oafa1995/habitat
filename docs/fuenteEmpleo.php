               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Principal fuente de empleo de clientes aprobados</span></h4>
                </li>
				</center>    
...
if($acumulador>=45 && $rr=="Trabajo/Empleo"){ $c1++;      
          } 
          
          
          if($acumulador>=45 && $rr=="Negocio"){ $c2++;
                   }
                
                    if($acumulador>=45 && $rr=="Oficio"){ $c3++;
                }

                    if($acumulador>=45 && $rr=="Pensión"){ $c4++;
                }

                if($acumulador>=45 && $rr=="Remesas Familiares"){ $c5++;
                }
                   
                if($acumulador>=45 && $rr=="Otros"){ $c6++;
                }
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		data: [a,b,c,d,e,f],
		backgroundColor: ['blue','violet','red','yellow','orange','green'],
		label: 'Comparacion de navegadores'}],
		labels: ['Trabajo/Empleo','Negocio','Oficio','Pensión','Remesas Familiares','Otros']},
    options: options
});
</script>
	   
Empleo/Trabajo: <?php echo $c1; ?><br>
Negocio: <?php echo $c2; ?><br>
Oficio: <?php echo $c3; ?><br>
Pensión: <?php echo $c4; ?><br>
Remesas Familiares: <?php echo $c5; ?><br>
