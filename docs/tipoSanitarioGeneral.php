               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Tipo de sanitario usado por Beneficiarios</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Letrina de fosa"){ $c1++;
     	}
         
          if($acumulador>=45 && $rr=="Letrina Abonera"){ $c2++;                    
          }  
          if($acumulador>=45 && $rr=="Sistema de lavar"){ $c3++;                    
          }   

   if($acumulador>=45 && $rr=="No tiene"){ $c4++;                    
          }   
   if($acumulador>=45 && $rr=="Usa la de un vecino/familiar"){ $c5++;                    
          }    
...
if($acumulador>=45 && $rr=="Letrina de fosa"){ $c1++;
     	}
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Letrina de fosa','Letrina Abonera','Sistema de lavar','No tiene','Usa la de un vecino/familiar']},
    options: options
});
...
Letrina de fosa: <?php echo $c1; ?><br>
Letrina Abonera: <?php echo $c2; ?><br>

Sistema de lavar: <?php echo $c3; ?><br>
No tiene: <?php echo $c4; ?><br>

Usa la de un vecino/familiar: <?php echo $c5; ?><br>
