...
<body>
  ...
  <div class="container-fluid"  style="margin: 50px 0;">
        ...
        <div class="container-fluid">
            ...
            <li role="presentation"><a href="v1.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Reportes de aprobacion</a></li>
            <li role="presentation"><a href="v2.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Reportes sección-Situación económica familiar</a></li>
            <li role="presentation"><a href="v3.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Reportes sección-Situación habitacional</a></li>
            <li role="presentation"><a href="v4.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Reportes sección-Situación Salud</a></li>
