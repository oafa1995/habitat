               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Formas de abastecimiento de energia electrica</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Propia"){ $c1++;
          ...
          if($acumulador>=45 && $rr=="Vecino"){ $c2++;                    
          }  
          if($acumulador>=45 && $rr=="Paneles Solares"){ $c3++;                    
          }   

   if($acumulador>=45 && $rr=="Otros"){ $c4++;                    
          }   
   if($acumulador>=45 && $rr=="Ninguna"){ $c5++;                    
          }    
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Propia','Vecino','Paneles Solares','Otros','Ninguna']},
    options: options
});
...
Vecino: <?php echo $c2; ?><br>

Paneles Solares: <?php echo $c3; ?><br>
Otros: <?php echo $c4; ?><br>

Ninguna: <?php echo $c5; ?><br>
