               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">¿En los últimos 3 meses por falta de recursos alguna vez se quedaron sin desayunar, almorzar o cenar?</span></h4>
                </li>
				</center>    
...
if($rr=="Si" && $acumulador>=45){

$c1++;
}

if($rr=="No" && $acumulador>=45){

    $c2++;
    }

if($rr=="A veces" && $acumulador>=45){
