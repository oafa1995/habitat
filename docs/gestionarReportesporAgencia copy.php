...
<body>
  ...
  <div class="container-fluid"  style="margin: 50px 0;">
        ...
        <div class="container-fluid">
            ...
            <li role="presentation"><a href="v1P.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Reportes de aprobacion</a></li>
            <li role="presentation"><a href="v2P.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Reportes sección-Situación económica familiar</a></li>
            <li role="presentation"><a href="v3P.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Reportes sección-Situación habitacional</a></li>
            <li role="presentation"><a href="v4P.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Reportes sección-Situación Salud</a></li>
