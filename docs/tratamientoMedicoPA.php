               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">¿Está bajo un tratamiento médico?</span></h4>
                </li>
				</center>    
