               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Motivo por el que los ingresos fueron afectados</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Disminuyeron"){ $c1++;
     	}
         
         if($acumulador>=45 && $rr=="Aumentaron"){ $c2++;                    
          }  
          
          if($acumulador>=45 && $rr=="Se mantuvieron"){ $c3++;                    
          }   
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Disminuyeron','Aumentaron','Se mantuvieron']},
    options: options
});
...
Disminuyeron: <?php echo $c1; ?><br>
Aumentaron: <?php echo $c2; ?><br>
Se mantuvieron: <?php echo $c3; ?><br>
