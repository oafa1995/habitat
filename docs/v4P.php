...
<body>
  ...
  <div class="container-fluid"  style="margin: 50px 0;">
        ...
        <div class="container-fluid">
            ...
            <li role="presentation"><a href="saludFamiliarPA.php?iddatos=<?php echo $iddatos; ?>"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Salud Familiar</a></li>
				<li role="presentation"><a href="enfermedadCronicaPA.php?iddatos=<?php echo $iddatos; ?>"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Familiares con enfermedad cronica</a></li>
				<li role="presentation"><a href="enfermedadesCronicasPA.php?iddatos=<?php echo $iddatos; ?>"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Enfemerdades cronicas que parecen los familiares</a></li>
                <li role="presentation"><a href="tratamientoMedicoPA.php?iddatos=<?php echo $iddatos; ?>"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Esta bajo tratamiento medico</a></li>
