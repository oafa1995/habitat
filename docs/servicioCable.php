               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Servicio de Cable</span></h4>
                </li>
				</center>    
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Tiene Servicio de Cable','No tiene Servicio de Cable']},
    options: options
});
...
Tiene Servicio de Cable: <?php echo $conH; ?><br>
No tiene Servicio de Cable: <?php echo $conM; ?><br>
       Total: <?php echo $conH+$conM; ?>
