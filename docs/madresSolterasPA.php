               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Madres Solteras Aprobadas</span></h4>
                </li>
				</center>    
...
<?php
$query_sp= pg_query($conexion, "select grupo_familiar from cliente where idcliente='$idcliente' and parentesco='hijo(a)' ");
$rowp=pg_num_rows($query_sp);
$estadoC=$filaw[11];
?>
			   

                        
<?php if($acumulador>=45 && $sexo=="femenino" && $estadoC=="soltero" && $rowp>=1){ ?>
                        <tr>
