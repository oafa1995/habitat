               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Partes dañadas de vivienda evaluada</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Techo"){ $c1++;
     	}
         
          if($acumulador>=45 && $rr=="Paredes"){ $c2++;                    
          }   

          if($acumulador>=45 && $rr=="Piso"){ $c3++;                    
          } 

           
             if($acumulador>=45 && $rr=="Baño"){ $c4++;                    
          }   
          
          if($acumulador>=45 && $rr=="Puertas"){ $c5++;                    
          }   
          

       if($acumulador>=45 && $rr=="Ventanas"){ $c6++;                    
          }   
           if($acumulador>=45 && $rr=="Ninguna"){ $c7++;                    
          }   
            if($acumulador>=45 && $rr=="Otro"){ $c8++;                    
          }   
...
total="<?php echo $c1+$c2+$c3+$c4+$c5+$c6+$c7+$c8; ?>";
...
if($acumulador>=45 && $rr=="Tierra"){ $c1++;
     	}
         
          if($acumulador>=45 && $rr=="Cemento"){ $c2++;                    
          }   

          if($acumulador>=45 && $rr=="Ladrillo de piso"){ $c3++;                    
          } 

           
             if($acumulador>=45 && $rr=="Cerámica"){ $c4++;                    
          }   
          
       if($acumulador>=45 && $rr=="Otro"){ $c5++;                    
          }   
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		backgroundColor: ['blue','red','green','brown','purple','black','cyan','orange'],
		label: 'Comparacion de navegadores'}],
		labels: ['Techo','Paredes','Piso','Baño','Puertas','Ventanas','Ninguno','Otro']},
    options: options
});
...
Paredes: <?php echo $c2; ?><br>
Piso: <?php echo $c3; ?><br>
Baño: <?php echo $c4; ?><br>
Puertas: <?php echo $c5; ?><br>
Ventanas: <?php echo $c6; ?><br>
Ninguno: <?php echo $c7; ?><br>
Otro: <?php echo $c8; ?><br>
