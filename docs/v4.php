...
<body>
  ...
  <div class="container-fluid"  style="margin: 50px 0;">
        ...
        <div class="container-fluid">
            ...
            <li role="presentation"><a href="saludFamiliar.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Salud Familiar</a></li>
				<li role="presentation"><a href="enfermedadCronica.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Familiares con enfermedad cronica</a></li>
				<li role="presentation"><a href="enfermedadesCronicas.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Enfemerdades cronicas que parecen los familiares</a></li>
                <li role="presentation"><a href="tratamientoMedico.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Esta bajo tratamiento medico</a></li>
