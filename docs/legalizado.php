               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Motivos por los que no ha legalizado la propiedad</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="lotificacion ilegal"){ $c1++;
     	}
         
         if($acumulador>=45 && $rr=="linea ferrea"){ $c2++;                    
          }  
          
          if($acumulador>=45 && $rr=="razones economicas"){ $c3++;                    
          }   
          
          if($acumulador>=45 && $rr=="aceptación de herencia"){ $c4++;                    
          } 
          
          if($acumulador>=45 && $rr=="procesos burocraticos"){ $c5++;                    
          }  
           if($acumulador>=45 && $rr=="Otro (ISTA)"){ $c6++;                    
          }   
           if($acumulador>=45 && $rr=="no aplica"){ $c7++;                    
          }   
...
total="<?php echo $c1+$c2+$c3+$c4+$c5+$c6+$c7; ?>";
...
/*
 if($acumulador>=45 && $rr=="Enfermedad"){ $c1++;
         ...
         if($acumulador>=45 && $rr=="No"){ $c2++;                    
          ...
          if($acumulador>=45 && $rr=="En proceso"){ $c3++;                    
          }   
          
          if($acumulador>=45 && $rr=="Otro"){ $c4++;                    
          }   
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		backgroundColor: ['blue','red','green','brown','black','orange','purple'],
		label: 'Comparacion de navegadores'}],
		labels: ['Lotificacion ilegal','Linea ferrea','Razones economicas','Aceptación de herencia','Procesos burocraticos','Otro (ISTA)','No aplica']},
    options: options
});
...
Lotificacion ilegal: <?php echo $c1; ?><br>
Linea ferrea: <?php echo $c2; ?><br>
Razones economicas: <?php echo $c3; ?><br>
Aceptación de herencia: <?php echo $c4; ?><br>

procesos burocraticos: <?php echo $c5; ?><br>

Otro (ISTA): <?php echo $c6; ?><br>

No aplica: <?php echo $c7; ?><br>
