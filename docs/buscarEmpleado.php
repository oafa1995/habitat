...
<html>
<head>
    <title>Inicio <?php echo $idagencia; ?></title>
    <meta charset="UTF-8">
...
function llamarPaginaEditar(id){
	window.open("editarEmpleado.php?iddatos="+id, '_parent');
	}
        ...
        <table id="grid" class="display" cellspacing="0" width="99%">
            <thead>
               ...
               <tbody>
			    <?php
                        include("../config/conexion.php");
						$query_s= pg_query($conexion, "select u.idusuario,u.nombres,u.apellidos,u.dui,(select nombre_cargo from cargo where idcargo=u.idcargo) from usuario as u, usuario_agencia as ua where u.idusuario=ua.idusuario and ua.idagencia='$idagencia' and u.estado=1 and u.idcargo!=1 ");
						while($fila=pg_fetch_array($query_s)){
						?>
            ...
            <tr>
                ...
                <td class="text-center"><a class='btn btn-info btn-xs' onClick="llamarPaginaEditar('<?php echo $fila[0]; ?>')"><span class="glyphicon glyphicon-edit"></span> Editar</a></td>
