...
if($_SESSION['autenticado']!="yeah"){
  ...
  //  $idcliente=$_REQUEST["iddatos"];
    ...
    //$iddatos=$_REQUEST["iddatos"];
  $query_s=pg_query($conexion,"select id_situacion_enfoque_genero from solicitud_situacion_enfoque_genero where idsolicitud='$iddatos'");
  while($fila=pg_fetch_array($query_s)){
$idsituacion=$fila[0];  
  }

  $query_s=pg_query($conexion,"select quedarse,proveedor,responsabilidad,inteligencia,trabajar_fuera,mover_libremente,expresar_libremente,libre_violencia from situacion_enfoque_genero where id_situacion_enfoque_genero='$idsituacion'");
  while($fila=pg_fetch_array($query_s)){
    $que=$fila[0];
    $pv=$fila[1];
    $rp=$fila[2];
...
$('#grupoF').on('input', function () { 
  ...
  alertify.error("<h1>Error</h1>"+"<p>No ha agregado ningun cliente</p>"+"<img src='../img/error.png'>").dismissOthers();
   ...
   function r(id) { location.href="editar_finalEstudioSE.php?iddatos="+id
...
<div class="form-group">
  ...
  <option value="Si" <?php if($que=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($que=="No") echo "selected"; ?>>No</option>
  <option value="No Se" <?php if($que=="No Se") echo "selected"; ?>>No Se</option>
  <option value="No Responde" <?php if($que=="No Responde") echo "selected"; ?>>No Responde</option>
</select>
</div>
</div>
...
<div class="form-group">
  ...
  <option value="Si" <?php if($pv=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($pv=="No") echo "selected"; ?>>No</option>
  <option value="No Se" <?php if($pv=="No Se") echo "selected"; ?>>No Se</option>
  <option value="No Responde" <?php if($pv=="No Responde") echo "selected"; ?>>No Responde</option>
</select>
</div>
</div>
...
<div class="form-group">
  ...
  <option value="Si" <?php if($rp=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($rp=="No") echo "selected"; ?>>No</option>
  <option value="No Se" <?php if($rp=="No Se") echo "selected"; ?>>No Se</option>
  <option value="No Responde" <?php if($rp=="No Responde") echo "selected"; ?>>No Responde</option>
...
<div class="form-group">
  ...
  <option value="No Se" <?php if($it=="No Se") echo "selected"; ?>>No Se</option>
  <option value="No Responde" <?php if($it=="No Responde") echo "selected"; ?>>No Responde</option>
...
<div class="form-group">
  ...
  <option value="Si"  <?php if($tf=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($tf=="No") echo "selected"; ?>>No</option>
  <option value="No Se" <?php if($tf=="No Se") echo "selected"; ?>>No Se</option>
  <option value="No Responde" <?php if($tf=="No Responde") echo "selected"; ?>>No Responde</option>
...
<div class="form-group">
  ...
  <option value="Si" <?php if($ml=="Si") echo "selected"; ?> >Si</option>
  <option value="No" <?php if($ml=="No") echo "selected"; ?>>No</option>
  <option value="No Se" <?php if($ml=="No Se") echo "selected"; ?>>No Se</option>
  <option value="No Responde" <?php if($ml=="No Responde") echo "selected"; ?>>No Responde</option>
...
<div class="form-group">
  ...
  <option value="Si" <?php if($el=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($el=="No") echo "selected"; ?>>No</option>
  <option value="No Se" <?php if($el=="No Se") echo "selected"; ?>>No Se</option>
  <option value="No Responde" <?php if($el=="No Responde") echo "selected"; ?>>No Responde</option>
...
<div class="form-group">
  ...
  <option value="Si" <?php if($lv=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($lv=="No") echo "selected"; ?>>No</option>
  <option value="No Se" <?php if($lv=="No Se") echo "selected"; ?>>No Se</option>
  <option value="No Responde"  <?php if($lv=="No Responde") echo "selected"; ?>>No Responde</option>
...
$result=pg_query($conexion,"update situacion_enfoque_genero set quedarse='$quedarse',
proveedor='$proveedor',
responsabilidad='$responsabilidad',
inteligencia='$inteligencia',
trabajar_fuera='$trabajar_fuera',
mover_libremente='$mover_libremente',
expresar_libremente='$expresar_libremente',
libre_violencia='$libre_violencia'
where id_situacion_enfoque_genero='$idsituacion' ");
