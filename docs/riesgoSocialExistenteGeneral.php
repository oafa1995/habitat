...
if($rr=="Inseguridad Social" && $acumulador>=45){

$c1++;
}

if($rr=="Otro" && $acumulador>=45){
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Inseguridad Social','Otro','Ninguno']},
...
Inseguridad Social: <?php echo $c1; ?><br>
Otro: <?php echo $c2; ?><br>
