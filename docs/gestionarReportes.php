  ...
  <div class="container-fluid"  style="margin: 50px 0;">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation"><a href="gestionarReportesG.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Reportes a Nivel General</a></li>
				<li role="presentation"><a href="gestionarPorAgencia.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Reportes por Agencia </a></li>
