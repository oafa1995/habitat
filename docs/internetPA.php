               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Servicio de Internet</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Si"){ $conH++; ?>
                    
                    
                    
               
            <?php	}else{ if($acumulador>=45 && $rr=="No"){ $conM++?>
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Tiene Servicio de Internet','No tiene Servicio de Internet']},
    options: options
});
...
Tiene Servicio de Internet: <?php echo $conH; ?><br>
No tiene Servicio de Internet: <?php echo $conM; ?><br>
       Total: <?php echo $conH+$conM; ?>
