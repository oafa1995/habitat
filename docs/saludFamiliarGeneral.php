               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">¿Cómo califica la salud  de su familia en general?</span></h4>
                </li>
				</center>    
...
if($rr=="Muy Buena" && $acumulador>=45){

$c1++;
}

if($rr=="Buena" && $acumulador>=45){

    $c2++;
    }

    if($rr=="Regular" && $acumulador>=45){

        $c3++;
        }
         if($rr=="Mala" && $acumulador>=45){
...
total="<?php echo $total=$c1+$c2+$c3+$c4; ?>";
...
Muy Buena: <?php echo $c1; ?><br>
Buena: <?php echo $c2; ?><br>
Regular: <?php echo $c3; ?><br>
Mala: <?php echo $c4; ?><br>
