               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Tipo de combustible usado en vivienda</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Gas propano"){ $c1++;
     	}
         
          if($acumulador>=45 && $rr=="Leña"){ $c2++;                    
          }  
          if($acumulador>=45 && $rr=="Carbon"){ $c3++;                    
          }   
...
if($acumulador>=45 && $rr=="Gas propano"){ $c1++;
     	}
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Gas propano','Leña','Carbon','Otros']},
    options: options
});
...
Gas propano: <?php echo $c1; ?><br>
Leña: <?php echo $c2; ?><br>

Carbon: <?php echo $c3; ?><br>
