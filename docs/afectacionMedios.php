               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Afectación en Medios de vida</span></h4>
                </li>
				</center>    
...
if($rr=="Cultivos" && $acumulador>=45){

$c1++;
}

if($rr=="Muebles" && $acumulador>=45){

    $c2++;
    }

    if($rr=="Negocio" && $acumulador>=45){
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Cultivos','Muebles','Negocio','Otros','Ninguno']},
...
Cultivos: <?php echo $c1; ?><br>
Muebles: <?php echo $c2; ?><br>
Negocio: <?php echo $c3; ?><br>
