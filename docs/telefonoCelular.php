               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Beneficiarios que tienen telefono</span></h4>
                </li>
				</center>    
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Tiene teléfono','No tiene teléfono']},
    options: options
});
...
Tiene teléfono: <?php echo $conM; ?><br>
No tiene teléfono: <?php echo $conH; ?><br>
       Total: <?php echo $conH+$conM; ?>
