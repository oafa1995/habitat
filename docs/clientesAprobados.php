...
$query_s7777= pg_query($conexion,"select departamento,municipio from agencia where idagencia='$idagencia' ");
	  		 
while($fila= pg_fetch_array($query_s7777)){
   $deparatamento=$fila[0];    
   $municipio=$fila[1];
...
function llamarPaginaEditar(){
	window.open("reporteFS2local.php", '_blank');
	}
...
<body>
               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Clientes Aprobados Agencia <?php echo $municipio; ?></span></h4>
                </li>
				</center>    
    ...
    <li class="mobile-menu-button visible-xs" style="float: left !important;">
		...
		<br>
        <a class='btn btn-info btn-xl' onClick="llamarPaginaEditar()"><span class="glyphicon glyphicon-edit"></span> Imprimir en PDF</a>
...
if($acumulador>=45){ ?>
                ...
                <td align="left" style="font-size:15px"><?php echo $aux; ?></td>
