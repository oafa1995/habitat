               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Ingresos Mensuales</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Entre 100 a 200"){ $c1++;
     	}
         
         if($acumulador>=45 && $rr=="Entre 201 a 300"){ $c2++;                    
          }  
          
          if($acumulador>=45 && $rr=="Entre 301 a 600"){ $c3++;                    
          }   
          
          if($acumulador>=45 && $rr=="Entre 601 a 750"){ $c4++;                    
          } 

          if($acumulador>=45 && $rr=="Mayor a 750"){ $c5++;                    
          } 

        if($acumulador>=45 && $rr=="Ninguno"){ $c6++;                    
          } 
...
total="<?php echo $c1+$c2+$c3+$c4+$c5+$c6; ?>";
...
datasets: [{
   ...
   backgroundColor: ['blue','red','green','yellow','black','cyan'],
   label: 'Comparacion de navegadores'}],
   labels: ['Entre 100 a 200','Entre 201 a 300','Entre 301 a 600','Entre 601 y 750','Mayor a 750','Ninguno']},
options: options
});
...
Entre 100 a 200: <?php echo $c1; ?><br>
Entre 201 a 300: <?php echo $c2; ?><br>
Entre 301 a 600: <?php echo $c3; ?><br>
Entre 601 y 750: <?php echo $c4; ?><br>
Mayor a 750: <?php echo $c5; ?><br>
Ninguno: <?php echo $c6; ?><br>
  Total: <?php echo $c1+$c2+$c3+$c4+$c5+$c6; ?>
