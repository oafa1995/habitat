               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Materiales de piso de vivienda evaluada</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Tierra"){ $c1++;
     	}
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Tierra','Cemento','Ladrillo de piso','Cerámica','Otro']},
    options: options
});
...
Tierra: <?php echo $c1; ?><br>
Cemento: <?php echo $c2; ?><br>
Ladrillo de piso: <?php echo $c3; ?><br>
Cerámica: <?php echo $c4; ?><br>
Otro: <?php echo $c5; ?><br>
