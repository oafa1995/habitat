...
<div class="form-group">
  ...
  <div class="col-md-5">
  <textarea id="comentario_clave" name="comentario_clave" class="form-control input-md" autocomplete="off" required></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <textarea id="condicion_actual" name="condicion_actual" class="form-control input-md" autocomplete="off" required></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <textarea id="a_riesgo" name="a_riesgo" class="form-control input-md" autocomplete="off" required></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-2">
  <input type="date" id="fecha" name="fecha" placeholder="" class="form-control input-md" autocomplete="off" value="<?= (isset($_POST['fecha']))?$_POST['fecha']:""; ?>" required>
...
marker=null;
            ...
            var marker = L.marker([e.latitude, e.longitude]).bindPopup('Te encuentras aqui :)');
...
<div class="form-group">
  ...
  <div class="col-md-3">
  <input id="latitud" name="latitud" type="text" placeholder="" class="form-control input-md" autocomplete="off" required>
...
<div class="form-group">
  ...
  <div class="col-md-3">
  <input id="longitud" name="longitud" type="text" placeholder="" class="form-control input-md" autocomplete="off" required>
