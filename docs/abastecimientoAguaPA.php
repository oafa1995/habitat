               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Formas de abastecimiento de servicio de agua</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Domiciliar"){ $c1++;
     	}
         
          if($acumulador>=45 && $rr=="Cantarera"){ $c2++;                    
          }  
          if($acumulador>=45 && $rr=="Pozo"){ $c3++;                    
          }   

   if($acumulador>=45 && $rr=="Pipa"){ $c4++;                    
          }   
   if($acumulador>=45 && $rr=="Rio"){ $c5++;                    
          }    if($acumulador>=45 && $rr=="Vecino"){ $c6++;                    
          }   
...
if($acumulador>=45 && $rr=="Domiciliar"){ $c1++;
     	}
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Domiciliar','Cantarera','Pozo','Pipa','Rio','Vecino','Otro','Ninguna']},
    options: options
});
...
Domiciliar: <?php echo $c1; ?><br>
Cantarera: <?php echo $c2; ?><br>

Pozo: <?php echo $c3; ?><br>
Pipa: <?php echo $c4; ?><br>

Rio: <?php echo $c5; ?><br>
Vecino: <?php echo $c6; ?><br>
