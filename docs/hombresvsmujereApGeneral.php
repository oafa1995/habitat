...
<?php if($acumulador>=45 && $sexo=="masculino"){ $conH++; ?>
                    
                    
                    
               
            <?php	}else{ if($acumulador>=45 && $sexo=="femenino"){ $conM++?>
...
Total Mujeres: <?php echo $conM; ?><br>
Total Hombres: <?php echo $conH; ?><br>
  Total Hombres+Mujeres: <?php echo $conH+$conM; ?>
