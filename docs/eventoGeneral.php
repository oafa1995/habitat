               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Evento que daño las viviendas</span></h4>
                </li>
				</center>    
...
if($rr=="Inundación" && $acumulador>=45){

$c1++;
}

if($rr=="Deslave" && $acumulador>=45){

    $c2++;
    }

    if($rr=="Erupción de volcán" && $acumulador>=45){

        $c3++;
        }

        if($rr=="Incendio" && $acumulador>=45){

            $c4++;
            }


            if($rr=="Tormentas" && $acumulador>=45){

                $c5++;
                }   
                 if($rr=="Derrumbes" && $acumulador>=45){
...
total="<?php echo $total=$c1+$c2+$c3+$c4+$c5+$c6+$c7+$c8; ?>";
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		labels: ['Inundación','Deslave','Erupción de volcán','Incendio','Tormentas','Derrumbes','Ninguno','Otros']},
...
Inundación: <?php echo $c1; ?><br>
Deslave: <?php echo $c2; ?><br>
Erupción de volcán: <?php echo $c3; ?><br>
Incendio: <?php echo $c4; ?><br>
Tormentas: <?php echo $c5; ?><br>
Derrumbes: <?php echo $c6; ?><br>
