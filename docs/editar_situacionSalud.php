...
if($_SESSION['autenticado']!="yeah"){
 ...
 include("../config/conexion.php");
  //$iddatos=$_REQUEST["iddatos"];
  $query_s=pg_query($conexion,"select id_situacion_salud from solicitud_situacion_salud where idsolicitud='$iddatos'");
  ...
  //    $ridpaciente=$fila[0];
   $idsituacion=$fila[0];
     // $rfecha=$fila[3];
      ...
      $query_s=pg_query($conexion,"select salud_familiar,familiar_cronico,enfermedad_cronica,tratamiento,asiste_tratamiento,atencion_general,atencion_promotor,prevenir_dengue,sintomas_covid,medidas_covid,acceso_alimento,desayuno,menor_comida,familia_alimentacion,cultivos_propios,otro_enfermedad_cronica,otro_asiste_tratamiento,otro_atencion_general,otro_prevenir_dengue,otro_medidas_covid,otro_familia_alimentacion from situacion_salud where id_situacion_salud='$idsituacion'");
      while($fila=pg_fetch_array($query_s)){
        //    $ridpaciente=$fila[0];
         $sf=$fila[0];
         $fc=$fila[1];
        ...
        /////////////////////
         ...
         $ofa=$fila[20];
////////////////////////////////////
         $palabras1 = explode(", ", $ec);
         $cantiPala1 = count($palabras1); 
         
         
         $palabras2 = explode(", ", $pd);
         $cantiPala2 = count($palabras2); 
         
         $palabras3 = explode(", ", $mc);
...
$('#grupoF').on('input', function () { 
  ...
  alertify.error("<h1>Error</h1>"+"<p>No ha agregado ningun cliente</p>"+"<img src='../img/error.png'>").dismissOthers();
	...
	function r(id) { location.href="editar_situacionOrganizacion.php?iddatos="+id
...
//alert(oten);
if(oec!=""){
  document.getElementById('otro_enfermedad_cronica').value=oec;
}else{
...
//alert(oten);
if(oat!=""){
  document.getElementById('otro_asiste_tratamiento').value=oat;
}else{
...
//alert(oten);
if(oag!=""){
  document.getElementById('otro_atencion_general').value=oag;
}else{
...
//alert(oten);
if(opd!=""){
  document.getElementById('otro_prevenir_dengue').value=opd;
}else{
...
//alert(oten);
if(omd!=""){
  document.getElementById('otro_medidas_covid').value=omd;
}else{
...
//alert(oten);
if(ofa!=""){
  document.getElementById('otro_familia_alimentacion').value=ofa;
}else{
...
<div class="form-group">
  ...
  <option value="Muy Buena" <?php if($sf=="Muy Buena") echo "selected"; ?>>Muy Buena</option>
  <option value="Buena" <?php if($sf=="Buena") echo "selected"; ?>>Buena</option>
  <option value="Regular" <?php if($sf=="Regular") echo "selected"; ?>>Regular</option>
  <option value="Mala" <?php if($sf=="Mala") echo "selected"; ?>>Mala</option>
...
<div class="form-group">
  ...
  <option value="Si" <?php if($fc=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($fc=="No") echo "selected"; ?>>No</option>
...
<div class="form-group jornada">
  ...
  for($i = 0; $i < $cantiPala1; $i++){ 
    ...
    if($palabras1[$i] == "Presión Arterial"){
       echo "checked";
  ...
  for($i = 0; $i < $cantiPala1; $i++){ 
    ...
    if($palabras1[$i] == "Enfermedades Respiratorias"){
       echo "checked";
  ...
  for($i = 0; $i < $cantiPala1; $i++){ 
    ...
    if($palabras1[$i] == "Insuficiencia Renal"){
       echo "checked";
...
<div class="form-group">
  ...
  ?>
  >Presión Arterial</option>
  <option value="Enfermedades Respiratorias"
  <?php 
  ...
  ?>
  >Enfermedades Respiratoria</option>
  <option value="Cancer"
  <?php 
...
<div class="form-group">
  ...
  <option value="Si" <?php if($t=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($t=="No") echo "selected"; ?>>No</option>
  <option value="No Aplica" <?php if($t=="No Aplica") echo "selected"; ?>>No Aplica</option>
...
<div class="form-group">
  ...
  <option value="ECO o Unidad de Salud" <?php if($at=="ECO o Unidad de Salud") echo "selected"; ?>>ECO o Unidad de Salud</option>
  <option value="Hospital Nacional" <?php if($at=="Hospital Nacional") echo "selected"; ?>>Hospital Nacional</option>
  <option value="ISSS" <?php if($at=="ISSS") echo "selected"; ?>>ISSS</option>
  <option value="Clinica Privada" <?php if($at=="Clinica Privada") echo "selected"; ?>>Clinica Privada</option>
  <option value="ONG" <?php if($at=="ONG") echo "selected"; ?>>ONG</option>
  <option value="Otros" <?php if($at=="Otros") echo "selected"; ?>>Otros</option>
  <option value="Ninguno" <?php if($at=="Ninguno") echo "selected"; ?>>Ninguno</option>
</select>
</div>
</div>

<div class="form-group" id="div2">
          <label class="col-md-4 control-label" id="lotro_asiste_tratamiento ">Comentario</label>  
...
<div class="form-group">
  ...
  <option value="Hospital Nacional" <?php if($ag=="Hospital Nacional") echo "selected"; ?>>Hospital Nacional</option>
  <option value="ECO o Unidad de Salud" <?php if($ag=="ECO o Unidad de Salud") echo "selected"; ?>>ECO o Unidad de Salud</option>
  <option value="ISSS" <?php if($ag=="ISSS") echo "selected"; ?>>ISSS</option>
  <option value="Médico Particular" <?php if($ag=="Médico Particular") echo "selected"; ?>>Médico Particular</option>
  <option value="Remedios Caseros" <?php if($ag=="Remedios Caseros") echo "selected"; ?>>Remedios Caseros</option>
  <option value="Otros" <?php if($ag=="Otros") echo "selected"; ?>>Otros</option>
  <option value="Ninguno" <?php if($ag=="Ninguno") echo "selected"; ?>>Ninguno</option>
</select>
</div>
</div>
...
<div class="form-group">
  ...
  <option value="Si" <?php if($ap=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($ap=="No") echo "selected"; ?>>No</option>
  <option value="A Veces" <?php if($ap=="A Veces") echo "selected"; ?>>A Veces</option>
</select>
</div>
</div>
...
<div class="form-group jornada2">
  ...
  for($i = 0; $i < $cantiPala2; $i++){ 
    ...
    if($palabras2[$i] == "Eliminar Criaderos de Zancudos"){
       echo "checked";
  ...
  for($i = 0; $i < $cantiPala2; $i++){ 
    ...
    if($palabras2[$i] == "Usar mosquitero"){
       echo "checked";
...
<div class="form-group">
  ...
  <option value="Eliminar Criaderos de Zancudos" 
  <?php 
  ...
  ?>>Eliminar Criaderos de Zancudos</option>
  <option value="Usar mosquitero"
  <?php 
  ...
  ?>
  >Usar mosquitero</option>
  <option value="Aplicar Lejía"
  <?php 
...
<div class="form-group">
  ...
  <option value="No" <?php if($sc=="No") echo "selected"; ?>>No</option>
</select>
</div>
</div>
...
<div class="form-group jornada3">
  ...
  for($i = 0; $i < $cantiPala3; $i++){ 
    ...
    if($palabras3[$i] =="Lavado de Manos"){
       echo "checked";
  ...
  for($i = 0; $i < $cantiPala3; $i++){ 
    ...
    if($palabras3[$i] == "Uso de mascarillas"){
       echo "checked";
  ...
  for($i = 0; $i < $cantiPala3; $i++){ 
    ...
    if($palabras3[$i] == "Distanciamiento Social"){
       echo "checked";
  ...
  for($i = 0; $i < $cantiPala3; $i++){ 
    ...
    if($palabras3[$i] == "Uso de Lejía o cloro"){
       echo "checked";
...
<div class="form-group">
  ...
  <option value="Lavado de Manos"  <?php 
  ...
  ?>>Lavado de Manos</option>
  <option value="Uso de mascarillas"
  <?php 
  ...
  ?>
  >Uso de mascarillas</option>
  <option value="Distanciamiento Social"
  ...
  ?>
  >Distanciamiento Social</option>
  <option value="Alcohol gel"
  <?php 
  ...
  >Alcohol gel</option>
  <option value="Uso de Lejía o cloro"
  <?php 
...
<div class="form-group">
  ...
  <option value="Si" <?php if($al=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($al=="No") echo "selected"; ?>>No</option>
...
<div class="form-group">
  ...
  <option value="Si" <?php if($de=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($de=="No") echo "selected"; ?>>No</option>
  <option value="A Veces">A Veces</option>
...
<div class="form-group">
  ...
  <option value="Si" <?php if($mcc=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($mcc=="No") echo "selected"; ?>>No</option>
  <option value="A Veces" <?php if($mc=="A Veces") echo "selected"; ?>>A Veces</option>
...
<div class="form-group">
  ...
  <option value="Cultivando sus propios alimentos" <?php if($fa=="Cultivando sus propios alimentos") echo "selected"; ?>>Cultivando sus propios alimentos</option>
  <option value="Incremento de ingresos de la familia" <?php if($fa=="Incremento de ingresos de la familia") echo "selected"; ?>>Incremento de ingresos de la familia</option>
  <option value="Conociendo sobre preparación de alimentos" <?php if($fa=="Conociendo sobre preparación de alimentos") echo "selected"; ?>>Conociendo sobre preparación de alimentos</option>
  <option value="Otros" <?php if($fa=="Otros") echo "selected"; ?>>Otros</option>
...
<div class="form-group">
  ...
  <option value="Si" <?php if($cp=="Si") echo "selected"; ?>>Si</option>
  <option value="No" <?php if($cp=="No") echo "selected"; ?>>No</option>
...
if($bandera=="add"){
  ...
  $result=pg_query($conexion,"update situacion_salud set salud_familiar='$salud_familiar',   
  familiar_cronico='$familiar_cronico',  
  enfermedad_cronica='$enfermedad_cronica',    
  tratamiento='$tratamiento',
  asiste_tratamiento='$asiste_tratamiento',   
  atencion_general='$atencion_general',     
  atencion_promotor='$atencion_promotor',
  prevenir_dengue='$prevenir_dengue',       
  sintomas_covid='$sintomas_covid', 
  medidas_covid='$medidas_covid',         
  acceso_alimento='$acceso_alimento', 
  desayuno='$desayuno', 
  menor_comida='$menor_comida', 
  familia_alimentacion='$familia_alimentacion',   
  cultivos_propios='$cultivos_propios',   
  otro_enfermedad_cronica=NULLIF('$otro_enfermedad_cronica',''),
  otro_asiste_tratamiento=NULLIF('$otro_asiste_tratamiento',''),
  otro_atencion_general=NULLIF('$otro_atencion_general',''),
  otro_prevenir_dengue=NULLIF('$otro_prevenir_dengue',''),
  otro_medidas_covid=NULLIF('$otro_medidas_covid',''),
  otro_familia_alimentacion=NULLIF('$otro_familia_alimentacion','') 
  where id_situacion_salud='$idsituacion' " );
