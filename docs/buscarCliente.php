    ...
    <li class="mobile-menu-button visible-xs" style="float: left !important;">
        ...
        <table id="grid" class="display" cellspacing="0" width="99%">
            ...
            <tr>
                ...
                <td class="text-center"><a class='btn btn-info btn-xs' onClick="llamarPaginaFamiliares('<?php echo $fila[0]; ?>')"><span class="glyphicon glyphicon-edit"></span> Familiares</a></td>

                <td class="text-center"><a class='btn btn-success btn-xs' onClick="llamarPaginaEditar2('<?php echo $fila[0]; ?>')"><span class="glyphicon glyphicon-edit"></span> Ingresar Estudio Socioeconomico</a></td>
