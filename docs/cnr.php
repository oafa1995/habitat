               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Registro de propiedad en el CNR</span></h4>
                </li>
				</center>    
