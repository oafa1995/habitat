               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Materiales de paredes de viviendas afectadas</span></h4>
                </li>
				</center>    
...
<?php if($acumulador>=45 && $rr=="Bloque"){ $c1++;
     	}
...
var chart = new Chart(ctx, {
	...
	datasets: [{
		...
		backgroundColor: ['blue','red','green','brown','purple','black','orange'],
		label: 'Comparacion de navegadores'}],
		labels: ['Bloque','Ladrillo','Adobe','Lámina','Plástico','Bahareque','Otro']},
    options: options
});
...
Bloque: <?php echo $c1; ?><br>
Ladrillo: <?php echo $c2; ?><br>
Adobe: <?php echo $c3; ?><br>
Lámina: <?php echo $c4; ?><br>
Plástico: <?php echo $c5; ?><br>

Bahareque: <?php echo $c6; ?><br>
