...
function llamarPaginaEditar(id){
	window.open("editar_situacion_economica.php?iddatos="+id, '_parent');
	}
...
<body>
    ...
    <li class="mobile-menu-button visible-xs" style="float: left !important;">
        ...
        <a class='btn btn-info btn-xl' onClick="llamarPaginaIngresar('<?php echo $idcliente; ?>')"><span class="glyphicon glyphicon-edit"></span> Ingresar</a>
        ...
        <table id="grid" class="display" cellspacing="0" width="99%">
            ...
            <tr>
                ...
                <td class="text-center"><a class='btn btn-info btn-xs' onClick="llamarPaginaEditar('<?php echo $fila[0]; ?>')"><span class="glyphicon glyphicon-edit"></span> Detalles</a></td>
