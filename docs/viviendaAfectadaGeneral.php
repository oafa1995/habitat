               ...
               <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Viviendas afectadas</span></h4>
                </li>
				</center>    
