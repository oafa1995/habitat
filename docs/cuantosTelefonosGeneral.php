...
if($acumulador>=45 && $rr=="2"){ $c2++;                    
 ...
 if($acumulador>=45 && $rr=="Mas de 3"){ $c4++;                    
  ...
  if($acumulador>=45 && $rr=="Ninguno"){ $c5++;                    
 }   
