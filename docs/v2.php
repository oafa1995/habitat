...
<body>
  ...
  <div class="container-fluid"  style="margin: 50px 0;">
        ...
        <div class="container-fluid">
            ...
            <li role="presentation"><a href="madresSolteras.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Madres Solteras</a></li>
                <li role="presentation"><a href="fuenteEmpleo.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Fuentes de ingresos</a></li>
                <li role="presentation"><a href="remesas.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Remesas</a></li>
                <li role="presentation"><a href="ingresosMensuales.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Ingresos Mensuales</a></li>
                <li role="presentation"><a href="ultimoMeses.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Ingresos ultimos tres meses</a></li>
				<li role="presentation"><a href="motivoAfectacionIngresos.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Afectación de ingresos</a></li>
